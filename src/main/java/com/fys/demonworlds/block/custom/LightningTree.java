 ...
 * @since 2025-11-01
 */
public class LightningTree extends RotatedPillarBlock {
    ...
    protected static final Map<DeferredBlock<Block>, DeferredBlock<Block>> STRIPPABLES = new ImmutableMap.Builder<DeferredBlock<Block>, DeferredBlock<Block>>()
            .put(ModBlocks.LIGHTNING_LOG, ModBlocks.STRIPPED_LIGHTNING_LOG)
            .put(ModBlocks.LIGHTNING_WOOD, ModBlocks.STRIPPED_LIGHTNING_WOOD)
            .build();

    public LightningTree(Properties properties) {
        super(properties);
    }
