...
public class ModEnchantments {
    ...
    public static final ResourceKey<Enchantment> LIGHTNING_ENCHANTMENT = key("lightning_enchantment");
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context) {
        ...
        register(context, LIGHTNING_ENCHANTMENT, Enchantment.enchantment(
