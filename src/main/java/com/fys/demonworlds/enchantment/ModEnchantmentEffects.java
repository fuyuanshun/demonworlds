...
public class ModEnchantmentEffects {
    ...
    public static final DeferredHolder<MapCodec<? extends EnchantmentEntityEffect>, MapCodec<LightningEnchantmentEffect>> lightningEnchantment = EFFECTS.register("lightning_enchantment", () -> LightningEnchantmentEffect.CODEC);
