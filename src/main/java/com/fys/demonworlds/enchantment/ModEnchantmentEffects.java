...
public class ModEnchantmentEffects {
    ...
    public static final Holder<MapCodec<? extends EnchantmentEntityEffect>> LIGHTNING_ENCHANTMENT = EFFECTS.register("lightning_enchantment", () -> LightningEnchantmentEffect.CODEC);
