...
public class ModItems {
    ...
    //自定义工具
    public static final DeferredItem<AxeItem> END_AXE = ITEMS.register("end_axe", () -> new AxeItem(ModToolMaterial.END, 8, -2.5F, new Item.Properties()));
    public static final DeferredItem<Item> END_PICKAXE = ITEMS.register("end_pickaxe", () -> new Item(new Item.Properties().pickaxe(ModToolMaterial.END, 1.1F, -2.5F)));
    public static final DeferredItem<HoeItem> END_HOE = ITEMS.register("end_hoe", () -> new HoeItem(ModToolMaterial.END, -3F, -2.5F, new Item.Properties()));
    public static final DeferredItem<ShovelItem> END_SHOVEL = ITEMS.register("end_shovel", () -> new ShovelItem(ModToolMaterial.END, 1.8F, -2.8F, new Item.Properties()));
    ...
    public static final DeferredItem<AxeItem> BAT = ITEMS.register("bat", () -> new AxeItem(ModToolMaterial.END, 3, -1.0F, new Item.Properties()));
